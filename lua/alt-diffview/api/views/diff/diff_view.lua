...
local Rev = lazy.access("alt-diffview.vcs.adapters.git.rev", "GitRev") ---@type GitRev|LazyModule
local RevType = lazy.access("alt-diffview.vcs.rev", "RevType") ---@type RevType|LazyModule
local vcs_utils = lazy.require("alt-diffview.vcs") ---@module "alt-diffview.vcs"
