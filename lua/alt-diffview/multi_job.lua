...
---@alias MultiJob.OnRetryCallback fun(mj: MultiJob, jobs: alt-alt-diffview.Job[])
---@alias MultiJob.FailCond fun(mj: MultiJob): boolean, alt-diffview.Job[]?, string?

---@class MultiJob : Waitable
---@operator call : MultiJob
---@field jobs alt-diffview.Job[]
---@field retry integer
