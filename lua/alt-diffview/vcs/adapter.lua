...
local AsyncListStream = lazy.access("alt-diffview.stream", "AsyncListStream") ---@type AsyncListStream|LazyModule
local Job = lazy.access("alt-diffview.job", "Job") ---@type alt-diffview.Job|LazyModule
local Rev = lazy.access("alt-diffview.vcs.rev", "Rev") ---@type Rev|LazyModule
...
---@class VCSAdapter: alt-diffview.Object
