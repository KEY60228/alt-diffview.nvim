...
local View = lazy.access("alt-diffview.scene.view", "View") ---@type View|LazyModule
...
function StandardView:post_layout()
  if config.get_config().enhanced_diff_hl then
    self.winopts.diff2.a.winhl = {
      "DiffAdd:AltDiffviewDiffAddAsDelete",
      "DiffDelete:AltDiffviewDiffDeleteDim",
  ...
  AltDiffviewGlobal.emitter:emit("view_post_layout", self)
end
