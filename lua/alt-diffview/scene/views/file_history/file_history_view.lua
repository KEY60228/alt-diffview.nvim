...
local FileHistoryPanel = lazy.access("alt-diffview.scene.views.file_history.file_history_panel", "FileHistoryPanel") ---@type FileHistoryPanel|LazyModule
...
function FileHistoryView:post_open()
  self.commit_log_panel = CommitLogPanel(self.adapter, {
    name = ("alt-diffview://%s/log/%d/%s"):format(self.adapter.ctx.dir, self.tabpage, "commit_log"),
  })
...
function FileHistoryView:init_event_listeners()
  local listeners = require("alt-diffview.scene.views.file_history.listeners")(self)
