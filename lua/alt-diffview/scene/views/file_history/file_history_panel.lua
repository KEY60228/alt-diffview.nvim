...
local FHOptionPanel = lazy.access("alt-diffview.scene.views.file_history.option_panel", "FHOptionPanel") ---@type FHOptionPanel|LazyModule
local JobStatus = lazy.access("alt-diffview.vcs.utils", "JobStatus") ---@type JobStatus|LazyModule
local LogEntry = lazy.access("alt-diffview.vcs.log_entry", "LogEntry") ---@type LogEntry|LazyModule
local Panel = lazy.access("alt-diffview.ui.panel", "Panel") ---@type Panel|LazyModule
local PerfTimer = lazy.access("alt-diffview.perf", "PerfTimer") ---@type PerfTimer|LazyModule
local Signal = lazy.access("alt-diffview.control", "Signal") ---@type Signal|LazyModule
local WorkPool = lazy.access("alt-diffview.control", "WorkPool") ---@type WorkPool|LazyModule
...
local oop = lazy.require("alt-diffview.oop") ---@module "alt-diffview.oop"
local panel_renderer = lazy.require("alt-diffview.scene.views.file_history.render") ---@module "alt-diffview.scene.views.file_history.render"
local renderer = lazy.require("alt-diffview.renderer") ---@module "alt-diffview.renderer"
...
FileHistoryPanel.winopts = vim.tbl_extend("force", Panel.winopts, {
  cursorline = true,
  winhl = {
    "EndOfBuffer:AltDiffviewEndOfBuffer",
    "Normal:AltDiffviewNormal",
    "CursorLine:AltDiffviewCursorLine",
    "WinSeparator:AltDiffviewWinSeparator",
    "SignColumn:AltDiffviewNormal",
    "StatusLine:AltDiffviewStatusLine",
    "StatusLineNC:AltDiffviewStatuslineNC",
  },
})

FileHistoryPanel.bufopts = vim.tbl_extend("force", Panel.bufopts, {
  filetype = "AltDiffviewFileHistory",
})
...
function FileHistoryPanel:init(opt)
  ...
  self:super({
    ...
    bufname = "AltDiffviewFileHistoryPanel",
  })
