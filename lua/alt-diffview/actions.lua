...
local HelpPanel = lazy.access("alt-diffview.ui.panels.help_panel", "HelpPanel") ---@type HelpPanel|LazyModule
...
local M = setmetatable({}, {
  __index = function(_, k)
    utils.err((
      ...
      .. "See ':h alt-diffview-available-actions' for an overview of available actions."
    ):format(k))
  end
})
...
---@class alt-diffview.ConflictCount
---@field total integer
...
for _, name in ipairs(action_names) do
  M[name] = function()
    require("alt-diffview").emit(name)
  end
end
