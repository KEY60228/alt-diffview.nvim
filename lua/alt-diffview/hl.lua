...
local git_status_hl_map = {
  ["A"] = "AltDiffviewStatusAdded",
  ["?"] = "AltDiffviewStatusUntracked",
  ["M"] = "AltDiffviewStatusModified",
  ["R"] = "AltDiffviewStatusRenamed",
  ["C"] = "AltDiffviewStatusCopied",
  ["T"] = "AltDiffviewStatusTypeChanged",
  ["U"] = "AltDiffviewStatusUnmerged",
  ["X"] = "AltDiffviewStatusUnknown",
  ["D"] = "AltDiffviewStatusDeleted",
  ["B"] = "AltDiffviewStatusBroken",
  ["!"] = "AltDiffviewStatusIgnored",
}
...
M.hl_links = {
  ...
  FilePanelRootPath = "AltDiffviewFilePanelTitle",
...
function M.update_diff_hl()
  ...
  M.hi("AltDiffviewDiffAddAsDelete", { fg = fg, bg = bg, style = style })
  M.hi_link("AltDiffviewDiffDeleteDim", "Comment", { default = true })

  if config.get_config().enhanced_diff_hl then
    M.hi_link("AltDiffviewDiffDelete", "AltDiffviewDiffDeleteDim")
  end
end
...
function M.setup()
  for name, v in pairs(M.get_hl_groups()) do
    ...
    M.hi("AltDiffview" .. name, v)
  end

  for from, to in pairs(M.hl_links) do
    M.hi_link("AltDiffview" .. from, to, { default = true })
  end
