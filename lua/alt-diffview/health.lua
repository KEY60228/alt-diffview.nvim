...
function M.check()
  if vim.fn.has("nvim-0.7") == 0 then
    health.error("AltDiffview.nvim requires Neovim 0.7.0+")
  end
  ...
  ;(function()
    ...
    local adapter_kinds = {
      { class = require("alt-diffview.vcs.adapters.git").GitAdapter, name = "Git" },
      { class = require("alt-diffview.vcs.adapters.hg").HgAdapter, name = "Mercurial" },
    }
