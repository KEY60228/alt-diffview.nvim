...
---@alias alt-diffview.Job.OnOutCallback fun(err?: string, line: string, j: alt-alt-diffview.Job)
---@alias alt-diffview.Job.OnExitCallback fun(j: alt-alt-diffview.Job, success: boolean, err?: string)
---@alias alt-diffview.Job.OnRetryCallback fun(j: alt-alt-diffview.Job)
---@alias alt-diffview.Job.FailCond fun(j: alt-alt-diffview.Job): boolean, string

---@alias StdioKind "in"|"out"|"err"

---@class alt-alt-diffview.Job : Waitable
---@operator call: alt-alt-diffview.Job
---@field command string
---@field args string[]
---@field cwd string
---@field retry integer
---@field check_status alt-diffview.Job.FailCond
...
---@field on_stdout_listeners alt-diffview.Job.OnOutCallback[]
---@field on_stderr_listeners alt-diffview.Job.OnOutCallback[]
---@field on_exit_listeners alt-diffview.Job.OnExitCallback[]
---@field on_retry_listeners alt-diffview.Job.OnRetryCallback[]
...
---@param pipe uv_pipe_t
---@param out string[]
---@param line_listeners? alt-diffview.Job.OnOutCallback[]
...
---@param callback alt-diffview.Job.OnOutCallback
...
---@param callback alt-diffview.Job.OnExitCallback
function Job:on_exit(callback)
  table.insert(self.on_exit_listeners, callback)
end

---@param callback alt-diffview.Job.OnRetryCallback
