...
local get_user_config = require("alt-diffview.config").get_config
...
function HelpPanel:render()
  ...
  comp:add_line(s, "AltDiffviewFilePanelTitle")
  ...
  for _, section in ipairs(self.components.sections) do
    ...
    comp:add_line(("%14s    CALLBACK"):format("KEYS"), "AltDiffviewFilePanelCounter")

    for _, item in ipairs(section.items) do
      ---@cast item CompStruct
      comp = item.comp
      comp:add_text(comp.context.label_lhs, "AltDiffviewSecondary")
