...
local helpers = require("alt-diffview.tests.helpers")
...
describe("diffview.stream", function()
  local Stream = require("alt-diffview.stream").Stream
  local AsyncStream = require("alt-diffview.stream").AsyncStream
